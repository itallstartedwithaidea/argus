...
def generate_post(context=""):
    r = client().messages.create(model="claude-sonnet-4-20250514", max_tokens=1000, system=SYSTEM,
...
def generate_comment(title, content, existing=""):
    r = client().messages.create(model="claude-sonnet-4-20250514", max_tokens=300, system=SYSTEM,
...
def generate_reply(title, comment):
    r = client().messages.create(model="claude-sonnet-4-20250514", max_tokens=250, system=SYSTEM,
